...
### Codex support: runtime verified; lifecycle adapter in development
...
path and the Git validation floor. Run `estate-sync` and `session-start`
explicitly at orientation; no project `.codex` lifecycle configuration is
currently generated by MarkdownLLM.

#### Codex desktop runtime compatibility (verified 2026-08-11)
...
|------|-----------|--------|
| Codex desktop | AGENTS.md auto-load | Runtime and deterministic Git floor verified 2026-08-11; lifecycle adapter in development ([plan](things/plans/vendor-harness-adapter-foundation.md)) |
