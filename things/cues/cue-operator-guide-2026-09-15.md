---
id: cue-operator-guide-2026-09-15
type: cue
status: answered
version: 1.0
created: 2026-09-15
...
corrected the `scaffold` row of the toolbox table, which said omitting the harness flag preserved the Claude compatibility default in `docs/operator-guide.md`. The guide now says what the tool does: omitted,
