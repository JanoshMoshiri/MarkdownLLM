---
id: cue-domain-specification-guide-2026-09-15
type: cue
status: answered
version: 1.0
created: 2026-09-15
subject: domain-specification-guide
...
# Cue: `domain-specification-guide` was modified — inflection?

## The Change
The build commit for `scaffold-harness-is-an-explicit-selection-2026-09-15`
corrected step 2's *Scaffold the mechanical shell* sentence, which said omission preserved the current Claude compatibility default in `domain-specification-guide.md`. The guide now says what the tool does: omitted,
